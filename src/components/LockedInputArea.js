import styles from 'css/LockedInputArea.module.css';
import React from "react";

const LockedInputArea = ({ className, placeholder, value, onChange, onClick, children , type}) => {
  return (
    // 전체 크기는 기본 가로 260px
...
export default LockedInputArea;